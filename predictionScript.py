...
def get_available_events(course_type, age):
    ...
    event_patterns = [
        ('50 Freestyle', f'50Freestyle_{course_type}_Age{age}_FastestTime'),
        ('100 Freestyle', f'100Freestyle_{course_type}_Age{age}_FastestTime'),
        ('200 Freestyle', f'200Freestyle_{course_type}_Age{age}_FastestTime'),
        ('400 Freestyle', f'400Freestyle_{course_type}_Age{age}_FastestTime'),
        ('800 Freestyle', f'800Freestyle_{course_type}_Age{age}_FastestTime'),
        ('1500 Freestyle', f'1500Freestyle_{course_type}_Age{age}_FastestTime'),
        ('50 Backstroke', f'50Backstroke_{course_type}_Age{age}_FastestTime'),
        ('100 Backstroke', f'100Backstroke_{course_type}_Age{age}_FastestTime'),
        ('200 Backstroke', f'200Backstroke_{course_type}_Age{age}_FastestTime'),
        ('50 Breaststroke', f'50Breaststroke_{course_type}_Age{age}_FastestTime'),
        ('100 Breaststroke', f'100Breaststroke_{course_type}_Age{age}_FastestTime'),
        ('200 Breaststroke', f'200Breaststroke_{course_type}_Age{age}_FastestTime'),
        ('50 Butterfly', f'50Butterfly_{course_type}_Age{age}_FastestTime'),
        ('100 Butterfly', f'100Butterfly_{course_type}_Age{age}_FastestTime'),
        ('200 Butterfly', f'200Butterfly_{course_type}_Age{age}_FastestTime'),
        ('100 IM', f'100IM_{course_type}_Age{age}_FastestTime'),
        ('200 IM', f'200IM_{course_type}_Age{age}_FastestTime'),
        ('400 IM', f'400IM_{course_type}_Age{age}_FastestTime'),
    ]
